...
def main():
    ...
    while True:
        ...
        if class_names:
            if "Mochila" in class_names:
                indice = class_names.index("Mochila")
                enviar_a_ros(class_names [indice], distances [indice], errors [indice])
            else:
                enviar_a_ros(class_names [0], distances [0], errors [0])
